...
export default function Login(){
    ...
    function formSubmissionHandler(e){
        ...
        if(!enteredEmail.trim().includes('@gmail.com')){
            setErrorMsg('Invalid email.Missing @gmail.com')
            setTimeout(() => {
                setErrorMsg('')
            },3000)
            return
    ...
    return <section className="bg-[#337CF7] h-[100vh] flex">
        <form className="w-[50%] h-[100vh] bg-white pl-44" onSubmit={formSubmissionHandler}>
            ...
            <div className="w-[60%] mt-8">
                <p className="font-medium">Email <span className="text-[#173DB3]">*</span></p>
                <input
                    value={enteredEmail}
            ...
            <div className="flex mt-10 space-x-4 font-medium">
                ...
                <button className="text-[#173DB3]">Create An Account</button>
            </div>
        </form>
        <div>
            <p>Design</p>
